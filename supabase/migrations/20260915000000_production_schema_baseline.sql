-- Prepared schema-only baseline exported from Production.
-- The raw pg_dump artifact is preserved at supabase/snapshots/20260915000000_production_schema_baseline.sql.
-- CREATE SCHEMA public and pg_dump \\restrict directives were removed because Supabase creates public and migration runners do not require psql meta commands.
--
